...
public class Byujs_Profile_with_Normalclass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@placeholder=\"Enter your mobile number\"]")).sendKeys("8975725507");
		...
		driver.findElement(By.xpath("(//span[contains(text(),'Pradeep Kardile')])[1]")).click();
		Thread.sleep(2000);
